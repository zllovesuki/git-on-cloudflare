        ...
        {commits.length ? (
          commits.map((commit) => {
            ...
            const mergeRowClass = isMerge
              ? "cursor-pointer border-l-4 border-indigo-400 bg-indigo-50/30 hover:bg-indigo-50/50 dark:border-indigo-600 dark:bg-indigo-900/10 dark:hover:bg-indigo-900/20"
              : "";
